...
`univer.createUniverDoc` 方法会创建并返回 `DocumentDataModel` 对象。
...
- [Univer 文档架构及模块设计](/zh-cn/blog/univer-doc-architecture)
- [Univer 文档排版设计初探](/zh-cn/blog/doc-typesetting-design)
