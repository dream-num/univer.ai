...
当前部署版本分为 lite（社区精简版）和 docker-compose（社区完整版）。
...
<Tabs>
  ...
  <TabItem label="windows-lite">
    1. 点击[下载](https://release-univer.oss-cn-shenzhen.aliyuncs.com/lite/windows.zip) Windows 10/11 x64版本。
        ...
        - 版本号: `v0.1.7`
        - SHA1: `ef14580acb96bad2cb20be67c5487f7df904eb1c`
        - SHA256: `4294dbe68db319dfd4dcbc4a22e6a9d6435b1f5039594064df18144c9a15bb09`
  ...
  <TabItem label="linux-lite">
    1. 点击[下载](https://release-univer.oss-cn-shenzhen.aliyuncs.com/lite/linux.zip) linux x64版本。
        ...
        - 版本号: `v0.1.7`
        - SHA1: `c477774f94ccbc6d7729fd793fcf921e6a50344c`
        - SHA256: `0f70c5edcd4112f23ff8c78678cfeb341f109ea4779275cdd23023f8c740c662`
  ...
  <TabItem label="mac-lite">
    1. 点击[下载](https://release-univer.oss-cn-shenzhen.aliyuncs.com/lite/mac.zip) Apple silicon版本。
        ...
        - 版本号: `v0.1.7`
        - SHA1: `a6a44d023a7dfef1c45b9373931d3e34534f4b68`
        - SHA256: `d74ee936262e7521cfb8957a67557c0969cb3e5061c27e22479582f3fe100f01`
...
替换 localhost 为本机 ip，并分享给其它内网同事。
...
检查防火墙是否启用,若启用请确保局域网内 Univer 的端口可被访问。
...
### 5. lite（社区精简版）和 docker-compose（社区完整版）有什么分别？

- 功能性：在功能上保持一致。
- 支持系统：
    - lite：支持 windows、linux、mac。
    - docker-compose: 支持 linux、mac。
- 具体实现：
    - lite：SQLite + 内存队列。
...
若仍然不能解决您的问题，请[联系社区](/zh-cn/guides/introduction#下一步)获取帮助。
