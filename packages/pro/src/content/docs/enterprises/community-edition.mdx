---
title: Community Edition Trial Guide
---
...
<Tabs>
  <TabItem label="docker-compose">
    ...
    1. Download repository from [release](https://github.com/dream-num/helm-charts/releases) 
...
### 7. S3 config for docker compose
...
```bash
# Example: S3_ENDPOINT_PUBLIC=http://univer-minio:9000
# Replace to: S3_ENDPOINT_PUBLIC=http://192.168.50.172:19000
```

If you are still unable to resolve your issue, [contact the community](/guides/introduction#whats-next) for assistance.
