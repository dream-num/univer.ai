...
<Tabs items={['pnpm', 'npm']}>
  <Tabs.Tab label="pnpm">
    ```shell
    pnpm add @univerjs-pro/collaboration @univerjs-pro/collaboration-client @univerjs-pro/print @univerjs-pro/sheets-print @univerjs-pro/live-share @univerjs-pro/sheets-exchange-client @univerjs-pro/sheets-data-connector
    ```
  </Tabs.Tab>
  <Tabs.Tab label="npm">
    ```shell
    npm install @univerjs-pro/collaboration @univerjs-pro/collaboration-client @univerjs-pro/print @univerjs-pro/sheets-print @univerjs-pro/live-share @univerjs-pro/sheets-exchange-client @univerjs-pro/sheets-data-connector
    ```
  </Tabs.Tab>
</Tabs>
