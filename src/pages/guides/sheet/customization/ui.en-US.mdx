...
## How to register a menu in a third-party plugin?
...
Make sure you understand the [plugin mechanism](/guides/architecture/univer) and have created a new plug-in via [@univerjs/create-cli](https://www.npmjs.com/package/@univerjs/create-cli).
