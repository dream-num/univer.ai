...
如果你在编写一个 Univer 插件，可以很方便的使用依赖注入系统中的 `IMenuService` 来注册菜单项。

### 1. 插件环境

确保你对[插件机制](/guides/architecture/univer)有所了解，并且已经通过 [@univerjs/create-cli](https://www.npmjs.com/package/@univerjs/create-cli) 新建了一个插件。
