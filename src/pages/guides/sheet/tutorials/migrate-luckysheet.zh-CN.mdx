...
|       | Univer         | Luckysheet |
|-------|----------------|------------|
| 条件格式 | [@univerjs/sheets-conditional-formatting](/api/sheets-conditional-formatting/)  | [luckysheet_conditionformat_save](https://dream-num.github.io/LuckysheetDocs/zh/guide/sheet.html#luckysheet-conditionformat-save)  |
| 数据验证 | [@univerjs/sheets-data-validation](/api/sheets-data-validation/) | [dataverification](https://dream-num.github.io/LuckysheetDocs/zh/guide/sheet.html#dataverification)      |
