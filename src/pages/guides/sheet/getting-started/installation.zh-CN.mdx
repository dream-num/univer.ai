...
我们推荐使用 [Vite](https://vitejs.dev/)、[esbuild](https://esbuild.github.io/) 或 [Webpack 5](https://webpack.js.org/) 等对 ES Module 支持较好的构建工具来构建 Univer 应用。如果你使用了其它构建工具（例如 Webpack 4），可能会需要一些额外的配置，请阅读 [更多](/guides/quickstart/#更多) 以及 [常见问题](/guides/troubleshooting) 获取更多信息。
...
<Callout type="info" emoji="ℹ️">
  ...
  **哪些插件需要引入样式文件？请参考 [插件](/api) 文档中标有 ![CSS Included](https://img.shields.io/badge/CSS_Included-blue?logo=CSS3) 的插件。**
</Callout>
