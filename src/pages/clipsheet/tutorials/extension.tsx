...
export default function Page() {
  ...
  const t = useTranslation({
    'en-US': {
      ...
      'hero.subtitle': 'Chrome Extension',
      'hero.desc': 'Use AI to help you extract all table data (Instant Data) from public web pages and generate sheets.',
      ...
      <main className="bg-[#fff]">
        ...
        >
          <div className="relative mx-auto max-w[1200px]">
            ...
            <div className={`
              mt-[20px] flex justify-center text-center text-lg
