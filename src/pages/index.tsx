...
export default function Page() {
  const t = useTranslation({
    'en-US': {
      ...
      'feature-2.desc': 'Univer Pro supports the import and export of Excel files. Docx and PPT will also be supported in the future.',
    ...
    'zh-CN': {
      ...
      'feature-2.desc': 'Univer Pro 支持导入和导出 Excel 文件',
      'feature-3.title': '打印',
