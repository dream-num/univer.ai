...
export default function Navbar(props: IProps) {
  ...
  const navs: NavType[] = [{
    ...
    title: 'Univer Pro',
    type: 'menu',
    desc: t('univer-pro.description'),
    href: '/pro',
    icon: '/images/univer-pro/logo.svg',
    items: [{
      title: t('univer-pro.guides.title'),
      desc: t('univer-pro.guides.desc'),
      href: '/pro/guides/sheet/introduction',
      icon: '/images/univer-pro/guides-icon.svg',
    }, {
      title: t('univer-pro.examples.title'),
      desc: t('univer-pro.examples.desc'),
      href: '/pro/examples',
      icon: '/images/univer-pro/examples-icon.svg',
    }],
  }, {
      ...
      >
        ...
        <div className="h-full">
          <Link className="flex h-full items-center" locale={router.locale} href={rootPath.includes('examples') ? '/' : rootPath}>
            <img src={logo} alt={title} draggable={false} />
          </Link>
        </div>
