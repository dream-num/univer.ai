      ...
      <SandpackProvider
        customSetup={{
          dependencies: {
            ...
            '@univerjs/docs': '0.2.9',
            '@univerjs/docs-ui': '0.2.9',
            '@univerjs/docs-hyper-link': '0.2.9',
            '@univerjs/docs-hyper-link-ui': '0.2.9',
            '@univerjs/engine-formula': '0.2.9',
            '@univerjs/engine-render': '0.2.9',
            '@univerjs/engine-numfmt': '0.2.9',
            '@univerjs/facade': '0.2.9',
            '@univerjs/network': '0.2.9',
            '@univerjs/sheets': '0.2.9',
            '@univerjs/sheets-formula': '0.2.9',
            '@univerjs/sheets-hyper-link': '0.2.9',
            '@univerjs/sheets-hyper-link-ui': '0.2.9',
            '@univerjs/sheets-numfmt': '0.2.9',
            '@univerjs/sheets-filter': '0.2.9',
            '@univerjs/sheets-filter-ui': '0.2.9',
            '@univerjs/sheets-sort': '0.2.9',
            '@univerjs/sheets-sort-ui': '0.2.9',
            '@univerjs/sheets-ui': '0.2.9',
            '@univerjs/sheets-zen-editor': '0.2.9',
            '@univerjs/ui': '0.2.9',
            '@univerjs/slides': '0.2.9',
            '@univerjs/slides-ui': '0.2.9',
            '@univerjs/rpc': '0.2.9',
            '@univerjs/data-validation': '0.2.9',
            '@univerjs/sheets-data-validation': '0.2.9',
            '@univerjs-pro/engine-pivot': '0.2.9',
            '@univerjs-pro/sheets-pivot': '0.2.9',
            '@univerjs-pro/sheets-pivot-ui': '0.2.9',
            '@univerjs/sheets-crosshair-highlight': '0.2.9',
            '@univerjs-pro/exchange-client': '0.2.9',
            '@univerjs-pro/facade': '0.2.9',
            vue: 'latest',
            dayjs: 'latest',
            react: 'latest',
            'react-dom': 'latest',
