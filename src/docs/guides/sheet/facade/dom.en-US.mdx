...
componentManager.register({
  componentKey: 'mySidebar',
  component: () => <div style={{ width: 100, height: 100, background: '#fff' }}>弹出内容</div>,
});
...
componentManager.register({
  ...
  component: () => <div style={{ width: 100, height: 100, background: '#fff' }}>Popup content</div>,
});
