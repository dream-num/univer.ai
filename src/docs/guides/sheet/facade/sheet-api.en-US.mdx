...
// if disposeable is null, it means that the popup is not added successfully
...
```tsx
// add a float dom
// if disposeable is null, it means that the float-dom is not added successfully
