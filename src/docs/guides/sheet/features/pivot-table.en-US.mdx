...
- @univerjs-pro/pivot-engine provides the most basic data calculation capabilities for pivot tables. The npm package does not rely on any third-party plug-ins for its work.
