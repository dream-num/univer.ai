...
1. [使用 IWorkbookData 创建 univer-Sheet](/sheet/features/core/sheet-api#创建工作表)
2. [从 univer-Sheet 中保存 IWorkbookData](/sheet/features/core/sheet-api#获取工作表数据)
...
| defaultStyle | `Nullable<IStyleData>` | 默认工作表样式 |
