...
<Tabs items={['pnpm', 'npm', 'yarn']}>
  ...
  <Tabs.Tab label="yarn">
    ```shell
    yarn add @univerjs/core @univerjs/design @univerjs/docs @univerjs/docs-ui @univerjs/engine-formula @univerjs/engine-render @univerjs/sheets @univerjs/sheets-formula @univerjs/sheets-ui @univerjs/ui react react-dom rxjs
    ```
  </Tabs.Tab>
</Tabs>
