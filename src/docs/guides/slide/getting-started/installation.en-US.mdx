...
<Callout>
  ...
  - Known issue: yarn@1 cannot correctly install `peerDependencies`. We have not tested the latest version of yarn. If you are using a newer version of yarn, please feel free to provide feedback on compatibility in [GitHub Issues](
</Callout>
