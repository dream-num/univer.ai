...
2. [Facade API 常用方法](/guides/sheet/features/core/general-api)
3. [Facade Sheet API 常用方法](/guides/sheet/features/core/sheet-api)
4. [Univer Doc API 常用方法](/guides/doc/facade/doc-api)
