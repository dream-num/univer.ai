...
> 1. Only `Credential verify` api will get credential headers from web browser, other api do not send credential headers because of called in internal enviroment. <br />
> 2. `userID` is string value type. <br />
