...
### How to change S3 config to use self component?  <a id="s3-config"></a>
...
### How to change redis config to use self component?  <a id="redis-config"></a>
...
### How to change rabbitmq config to use self component?  <a id="rabbitmq-config"></a>
