...
### How to change S3 config to use self compoment?  <a id="s3-config"></a>
...
### How to change redis config to use self compoment?  <a id="redis-config"></a>
...
### How to change rabbitmq config to use self compoment?  <a id="rabbitmq-config"></a>
