...
| name       | type        | description                           |
| ---------- | ----------- | ------------------------------------- |
| type       | * enum(int) | 1(doc), 2(sheet) <br/> pathinfo param |
...
| import.jsonID | string       | The import exchange result file id, it use for next api to get file content |
