...
<Tabs items={['pnpm', 'npm']}>
  <Tabs.Tab label="pnpm">
    ...
    cd univer-doc-start-kit && pnpm install
    ```
  </Tabs.Tab>
  <Tabs.Tab label="npm">
    ...
    cd univer-doc-start-kit && npm install
    ```
  </Tabs.Tab>
</Tabs>
...
- **🧱 基础概念**：阅读在 Univer 当中会反复出现的[基本概念](/guides/doc/getting-started/concepts)，以更好地使用和深入 Univer 项目。
- **🏗️ 进阶使用**：如果你想进一步提升你的 Univer 技能，可以查看[进阶使用](/guides/doc/getting-started/univer-plugins)章节。它涵盖了更多高级主题和技巧。
