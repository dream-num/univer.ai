...
0.1.13 版本后，Univer 不再内置任何语言包，所有语言包均由插件提供。如果你发现手动引入插件的语言包过于繁琐，我们还提供了一个构建工具插件，用于自动引入插件所需的语言包。请参考 [使用 Univer 插件](/guides/sheet/getting-started/univer-plugins) 获取更多信息。
...
Univer OSS 是一个充满包容性的开源项目，我们欢迎来自五湖四海的开发者为 Univer 添加或者改进语言包。如果你有兴趣为 Univer 贡献语言包，请参考 [贡献指南](/guides/doc/contributing)。
