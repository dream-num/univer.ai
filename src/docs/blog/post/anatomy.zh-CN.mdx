...
<Callout type="info" emoji="💡">
  Univer 官方文档中有一篇 [教程](/guides/sheet/tutorials/csv-import-plugin)，帮助读者通过编写一个 CSV 导入插件入门插件开发。建议在阅读博客之前完成该教程。
</Callout>
...
<Callout type="info" emoji="💡">
  了解 Univer 架构的 [分层模型](/guides/sheet/architecture/univer#以分层架构划分模块)。
</Callout>
...
<Callout type="info" emoji="💡">
  了解 [快照](/guides/sheet/getting-started/concepts#快照) 的概念。
</Callout>
...
<Callout type="info" emoji="💡">
  阅读 [命令系统](/guides/sheet/architecture/univer#命令系统) 了解什么是命令以及命令的三种类型。
</Callout>
...
<Callout type="info" emoji="💡">
  关于 Univer 的生命周期机制，请查看文档 [插件生命周期](/guides/sheet/architecture/univer#插件生命周期)。
</Callout>

<Callout type="info" emoji="💡">
  Univer 使用依赖注入模式来管理模块之间的依赖关系以及实例化模块。关于依赖注入的更多介绍，请参考我们的 [文档](/guides/sheet/architecture/univer#依赖注入)。
</Callout>
