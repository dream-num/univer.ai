...
For instructions on how to load a spreadsheet into a newly created Univer instance, please consult the [next section](/guides/quickstart/data) of our documentation.
...
Alternatively, you can also include Univer using the `<script>` tag. Please refer to the [Using UMD](/guides/quickstart/umd/) guide for further instructions.
