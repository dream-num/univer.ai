...
This configuration points the @univerjs scope to Univer's nightly version repository, which is hosted at https://verdaccio.univer.work. This is a private npm repository we provide specifically for testing and development purposes.
