...
:::tip
Uniscript 的 DSL 实际上是一套封装 Univer 内部实现细节的 API，这套 API 定义在[这里](https://github.com/dream-num/univer/blob/dev/packages/uniscript/src/facade/facade.ts)。
:::
...
export class YourModule {
    constructor(@Inject(ScriptEditorService) private readonly _scriptEditorService) {}
